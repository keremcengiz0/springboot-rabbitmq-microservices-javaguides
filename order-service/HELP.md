...
* The original package name 'net.javaguides.order-service' is invalid and this project uses 'net.javaguides.orderservice' instead.
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/docs/3.0.8/reference/htmlsingle/#messaging.amqp)
